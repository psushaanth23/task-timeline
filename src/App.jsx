    ...
    const lanes = Array.from({ length: laneCount }, (_, i) => {
      ...
      return {
        ...
        rowStyle: {
          ...
          position: 'relative',
          // Uniform drag affordance across the whole row; interactive controls
          // (bar/+/delete) and the editing name override this via their own style.
        ...
        barStyle: {
          ...
          background: tr.color,
          boxShadow: '0 0 9px ' + tr.color + '66, 4px 0 12px -5px ' + tr.color + '55',
          cursor: 'pointer',
          zIndex: 1,
        },
        nameStyle: {
